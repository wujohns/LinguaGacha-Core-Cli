...
export class TaskSnapshotBuilder {
  ...
  private build_task_snapshot_from_state(
    ...
    const progress = this.normalize_progress_snapshot(this.normalize_object(meta["analysis_extras"]));
  ...
  private resolve_task_type(
    ...
    if (requested_task_type !== "" && requested_task_type !== "analysis") {
      return "analysis";
    }
    if (engine_state.active_task_type === "analysis") {
      return "analysis";
    }
    return "analysis";
  }
